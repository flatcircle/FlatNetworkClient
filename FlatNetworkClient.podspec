...
Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "A short description of FlatNetworkClient."
  ...
  s.homepage     = "http://EXAMPLE/FlatNetworkClient"
  ...
  s.source       = { :git => "http://EXAMPLE/FlatNetworkClient.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "Classes", “FlatNetworkClient/*.swift”
